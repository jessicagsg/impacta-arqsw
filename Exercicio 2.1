...
Tempo de Resposta
Trecho: "O tempo de resposta de um monitor ou televisão indica o intervalo necessário para um pixel ativo (preto) 
...
URL: https://www.tecmundo.com.br/monitor/95072-tempo-resposta-atualizacao-monitor-afetam-games.htm

Responsividade
Trecho: "Quando falamos nestes termos em relação a sites, sistemas, portais, jogos ou qualquer coisa visualizada em
...
URL: http://blog.kendoo.com.br/2016/03/o-que-e-responsividade-e-como-ela-faz-diferenca-no-google/

Latência
Trecho: " Em uma rede, latência é sinônimo de atraso, é uma expressão de quanto tempo leva para um pacote de dados  ir de um
...
URL: https://brasilwork.com.br/duvidas/e-latencia-em-redes/

Throughput
Trecho: "O throughput é uma medida essencial para estimarmos o desempenho dos ativos de rede e também para as questões de
planejamento de capacidades"
URL: https://www.gifara.com.br/compreendendo-o-throughput/

Carga
Trecho:  O teste de desempenho de software tem como objetivo abordar a aplicabilidade e finalidade do teste de carga de
desempenho, analisando o fluxo de execução, tempos de resposta, confiabilidade e limites operacionais."
URL: https://www.tiespecialistas.com.br/2015/11/teste-de-desempenho-de-software/

Sensibilidade à carga / degradação
Trecho: "Na ATAM dois termos importantes foram cunhados. Um "ponto de sensibilidade" (sensitivity point) na arquitetura denota
...
URL: https://www.infoq.com/br/articles/add-nfrs
